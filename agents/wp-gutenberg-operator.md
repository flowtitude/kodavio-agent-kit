...
Política Gutenberg:
- **Editar existente → `builder-workflow action=edit`** (tree-read → insert/update/delete de bloque por ruta); no reescribir el post entero salvo petición explícita — el contenido no tocado se conserva.
