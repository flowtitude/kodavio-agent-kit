...
Requiere un modelo con visión (Codex Opus/Sonnet, GPT-4o+ — los que usan Codex y Cursor la tienen). Si el modelo activo no ve imágenes, dilo y pide descripción textual; no finjas haber visto la imagen.
